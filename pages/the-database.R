...
databasePage <- fluidPage(fluidRow(column(
  ...
  p("The dataset in the dummy format is available ", tags$a(href="https://github.com/LingConLab/Dagloan_database/blob/master/Convert/words_28032019_dummy.tsv", "here")),
  div(databaseTable)
)))