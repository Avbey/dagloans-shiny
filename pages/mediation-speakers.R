...
mediationSpeakersPage <- fluidPage(fluidRow(column(
  12,
  p("The four plots presented here show how lexical influence from Turkic is mediated by the local major languages (Lezgian and Avar) 
    across Daghestan. The data are split by districts on X axis. Y axis shows the percentage of the loans found in the elicited samples. 
